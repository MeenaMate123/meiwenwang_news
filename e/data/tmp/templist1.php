...
<script type="text/javascript">uaredirect("<?=$public_r['add_www_92game_net_phone']?>list/[!--self.classid--].html");</script>
...
<div class="container-bd list_top">
     <div class="main-wrap">
	     ...
	     <div class="title"><h3 class="ico-07"><a href="<?=$public_r['newsurl'].$class_r[$GLOBALS[navclassid]][classpath]?>">[!--class.name--]</a></h3>
...
?>
		...
		<div class="right-item">
		 ...
		 <div class="a250"><script src="[!--news.url--]d/js/acmsd/thea5.js"></script> </div>
		 </div>
		  </div>
     </div>
     </div>
