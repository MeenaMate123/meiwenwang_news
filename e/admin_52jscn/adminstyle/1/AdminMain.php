              ...
              <TABLE class=flyoutMenu border=0>
                <TBODY>
                  <TR align=middle> 
					...
					<TD width="60" class="flyoutLink" onclick="window.open('http://changyan.itc.cn/labs/audit/qing/TOAUDIT/1','','width=1250,height=760,scrollbars=auto,resizable=yes,top=80,left=120');" onmouseover="over(this)">畅言评论</TD>
					<!--<?php
					if($r[dopl])
					{
					?>
