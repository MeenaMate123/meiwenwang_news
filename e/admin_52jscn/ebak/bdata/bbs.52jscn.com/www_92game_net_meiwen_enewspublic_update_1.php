...
E_D("DROP TABLE IF EXISTS `www_92game_net_meiwen_enewspublic_update`;");
E_C("CREATE TABLE `www_92game_net_meiwen_enewspublic_update` (
...
E_D("replace into `www_92game_net_meiwen_enewspublic_update` values('1','1355124469','1355124476','3037','0','|1,3015|','','1436211184','1436211184','4','0','0','0');");
