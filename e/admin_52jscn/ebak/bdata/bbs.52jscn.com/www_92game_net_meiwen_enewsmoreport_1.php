...
E_D("DROP TABLE IF EXISTS `www_92game_net_meiwen_enewsmoreport`;");
E_C("CREATE TABLE `www_92game_net_meiwen_enewsmoreport` (
...
E_D("replace into `www_92game_net_meiwen_enewsmoreport` values('1','主访问端','','','','','0','0','0','0','');");
