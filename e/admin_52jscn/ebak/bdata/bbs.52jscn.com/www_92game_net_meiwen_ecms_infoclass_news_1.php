...
E_D("DROP TABLE IF EXISTS `www_92game_net_meiwen_ecms_infoclass_news`;");
E_C("CREATE TABLE `www_92game_net_meiwen_ecms_infoclass_news` (
  ...
  `zz_rclick` text NOT NULL,
  `z_rclick` varchar(255) NOT NULL,
  `qz_rclick` varchar(255) NOT NULL,
  `save_rclick` varchar(10) NOT NULL,
  `zz_zclick` text NOT NULL,
  `z_zclick` varchar(255) NOT NULL,
  `qz_zclick` varchar(255) NOT NULL,
  `save_zclick` varchar(10) NOT NULL,
  `zz_yclick` text NOT NULL,
  `z_yclick` varchar(255) NOT NULL,
  `qz_yclick` varchar(255) NOT NULL,
  `save_yclick` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
